        ...
        <tbody>
          @foreach ($listDonatur as $donatur)
            <tr>
              ...
              <td>{{ $donatur->nama }}</td>
              <td>
                  <a href="{{ route('donatur.show', $donatur->id) }}" class="btn btn-outline-info btn-sm"><i class="fas fa-info-circle"></i></a>
                  <a href="#" class="btn btn-outline-warning btn-sm btn-edit" data-id="<?= $donatur->id;?>" data-nama="<?= $donatur->nama;?>" data-jenis_donatur="<?= $donatur->jenis_donatur_id ?>" data-alamat="<?= $donatur->alamat;?>" data-nomor_ponsel="<?= $donatur->nomor_ponsel;?>"><i class="fas fa-pencil-alt"></i></a>
                  <a href="#" class="btn btn-outline-danger btn-sm btn-delete" data-id="<?= $donatur->id; ?>"><i class="far fa-trash-alt"></i></a>
              </td>
            </tr>
          @endforeach
        </tbody>
